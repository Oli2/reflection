...
if __name__ == "__main__":
    ...
    parser.add_argument('--fullresponse', type=bool, default=False, help='Return full response')
    args = parser.parse_args()
    system_prompt = """You are a legal assistant. Provide a detailed and accurate answer to the following question based"""
